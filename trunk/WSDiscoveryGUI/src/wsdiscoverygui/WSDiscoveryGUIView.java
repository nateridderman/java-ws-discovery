...
import ws_discovery.exception.WsDiscoveryException;
...
public class WSDiscoveryGUIView extends FrameView {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wsdiscoverygui.WSDiscoveryGUIApp.class).getContext().getActionMap(WSDiscoveryGUIView.class, this);
        buttonStart.setAction(actionMap.get("startWsDiscovery")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wsdiscoverygui.WSDiscoveryGUIApp.class).getContext().getResourceMap(WSDiscoveryGUIView.class);
