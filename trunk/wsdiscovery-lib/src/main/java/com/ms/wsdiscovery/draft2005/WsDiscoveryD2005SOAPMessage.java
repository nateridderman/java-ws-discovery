...
public class WsDiscoveryD2005SOAPMessage<E> extends SOAPOverUDPWSA200408Message implements ISOAPOverUDPMessage {
     ...
     */
    protected final WsDiscoveryNamespaces namespace = WsDiscoveryNamespaces.WS_DISCOVERY_2005_04;
     ...
     */
    public WsDiscoveryD2005SOAPMessage(SOAPMessage soap) throws SOAPOverUDPException {
        setSOAPMessage(soap);
    }

    public WsDiscoveryD2005SOAPMessage(ISOAPOverUDPMessage message) throws SOAPOverUDPException, WsDiscoveryException {
