...
public class WsDiscoveryD2005Utilities {
    ...
    public static WsDiscoveryScopesType createWsDiscoveryScopesObject(ScopesType scopes) {
        WsDiscoveryScopesType s = new WsDiscoveryScopesType(scopes.getMatchBy(), scopes.getValue(), scopes.getOtherAttributes());
        return s;
    }
    ...
    public static boolean isServiceMatchedBy(WsDiscoveryService service, ProbeType probe) {
        synchronized (service) {
            return service.isMatchedBy(probe.getTypes(), createWsDiscoveryScopesObject(probe.getScopes()));
        }
    }
     ...
     */
    public static EndpointReferenceType cloneEndpointReference(EndpointReferenceType er) {
