...
package ws_discovery.network.transport.soapudp.zlib;

import java.util.zip.DataFormatException;
import java.util.zip.Deflater;
import java.util.zip.Inflater;
import ws_discovery.network.NetworkMessage;
import ws_discovery.network.transport.ITransportType;
import ws_discovery.network.transport.exception.WsDiscoveryTransportException;
import ws_discovery.network.transport.soapudp.SOAPOverUDP;
...
public class SOAPOverUDPzlib extends SOAPOverUDP implements ITransportType {    
    /**
     *
     * @throws ws_discovery.network.transport.exception.WsDiscoveryTransportException
     */
