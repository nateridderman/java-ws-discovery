...
public class WSDiscoveryGUIAddServiceDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.ms.wsdiscovery.gui.WSDiscoveryGUIApp.class).getContext().getActionMap(WSDiscoveryGUIAddServiceDialog.class, this);
        jButton1.setAction(actionMap.get("addService")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.ms.wsdiscovery.gui.WSDiscoveryGUIApp.class).getContext().getResourceMap(WSDiscoveryGUIAddServiceDialog.class);
