...
import com.skjegstad.soapoverudp.generic.SOAPOverUDPGenericZlib;
 ...
 */
public class SOAPOverUDP11withZlib extends SOAPOverUDPGenericZlib implements ISOAPTransport {

    public SOAPOverUDP11withZlib() {
        super();
